...
*/
// upload this code in esp. the esp will release a wifi network, connect your phone or laptop to that network and now you can use it as the remote for the remote control car
